    ...
    class Startup : IWebJobsStartup
    {
        ...
        private static IAsyncPolicy<HttpResponseMessage> GetRetryPolicy()
        {
            ...
            return HttpPolicyExtensions
                ...
                .WaitAndRetryAsync(3, retryAttempt => TimeSpan.FromSeconds(4), (exception, retryCount, context) =>
                {
                    Console.WriteLine($"Retry: {retryCount}, StatusCode: {exception.Result.StatusCode}");
                });
